...
Public Declare Function init_mame Lib "MAME32" (ByVal id As Long, ByVal name As String, ByVal MameStart As Long, ByVal MameStop As Long, ByVal MameCopyData As Long, ByVal UpdateState As Long, ByVal MameOutput As Long) As Long
Public Declare Function close_mame Lib "MAME32" () As Long
Public Declare Function map_id_to_outname Lib "MAME32" (ByVal id As Long) As String
...
Public Function mame_output(ByVal name As String, ByVal value As Long) As Long
    Form1.Text1.Text = Form1.Text1.Text & "update_state: name=" & name & " value=" & value & vbNewLine
End Function
